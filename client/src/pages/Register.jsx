    ...
    try {
      ...
      if (res.ok) {
        ...
        setTimeout(() => {
          ...
          window.location.href = '/'; // This would redirect to login page
        }, 2000);
          ...
          <div className="text-center mb-8">
            <div className="relative w-24 h-24 mx-auto mb-6">
              ...
              <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-r from-amber-400 to-yellow-400 rounded-full flex items-center justify-center">
                <StarIcon className="w-4 h-4 text-white animate-pulse" />
              </div>
            ...
            <p className="text-green-100/90 text-lg flex items-center justify-center gap-2">
              <SeedIcon className="w-5 h-5 text-lime-300" />
            ...
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-white mb-2 flex items-center justify-center gap-2">
                    <SeedIcon className="w-6 h-6 text-lime-400" />
                    Create Farm Account
                  </h2>
                  <p className="text-green-200/80">Join our agricultural community</p>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <input
                      type="text"
                      className="w-full px-6 py-4 pl-14 bg-white/15 border border-white/30 rounded-2xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:border-blue-400/50 transition-all duration-300 backdrop-blur-sm group-hover:bg-white/20"
                      value={name}
                      onChange={(e) => setName(e.target.value)}
                      placeholder="Enter your full name"
                      required
                    />
                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 p-2 bg-blue-500/20 rounded-xl">
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-6 py-4 pl-14 pr-14 bg-white/15 border border-white/30 rounded-2xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-teal-400/50 focus:border-teal-400/50 transition-all duration-300 backdrop-blur-sm group-hover:bg-white/20"
                      value={confirmPassword}
                      onChange={(e) => setConfirmPassword(e.target.value)}
                      placeholder="Confirm your password"
                      required
                    />
                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 p-2 bg-teal-500/20 rounded-xl">
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-r from-green-500 via-emerald-500 to-lime-500 text-white font-bold py-4 rounded-2xl transition-all duration-300 transform group-hover:scale-[1.02] flex items-center justify-center gap-3">
                    {isLoading ? (
                      ...
                      <>
                        <SeedIcon className="w-5 h-5 group-hover:animate-pulse" />
                        Join Agriculture Community
                        <StarIcon className="w-4 h-4 group-hover:animate-spin" style={{animationDuration: '2s'}} />
                      </>
                    )}
                  </div>
                </button>
              ...
              <div className="flex items-center my-8">
                ...
                <div className="px-4 flex items-center gap-2">
                  ...
                  <span className="text-white/70 text-sm font-medium">Farm Benefits</span>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-amber-500/20 to-yellow-500/20 border border-amber-400/30 rounded-2xl text-amber-100 backdrop-blur-sm">
                  <WheatIcon className="w-4 h-4" />
                  <span className="text-xs font-medium">Crop Tracking</span>
                </div>
                <div className="flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-green-500/20 to-lime-500/20 border border-green-400/30 rounded-2xl text-green-100 backdrop-blur-sm">
                  <SunIcon className="w-4 h-4 text-yellow-400" />
                  <span className="text-xs font-medium">Weather Data</span>
                </div>
                <div className="flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-400/30 rounded-2xl text-emerald-100 backdrop-blur-sm">
                  <TractorIcon className="w-4 h-4" />
                  <span className="text-xs font-medium">Equipment</span>
                </div>
                <div className="flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-lime-500/20 to-green-500/20 border border-lime-400/30 rounded-2xl text-lime-100 backdrop-blur-sm">
              ...
              <div className="text-center">
                <div className="bg-white/5 rounded-2xl p-4 border border-white/10 backdrop-blur-sm">
                  <p className="text-white/80 text-sm mb-2 flex items-center justify-center gap-1">
                    <TractorIcon className="w-4 h-4 text-green-400" />
                    Already part of our farm?
                  </p>
                  <button 
                    onClick={() => window.location.href = '/'} // This would navigate to login page
                  ...
                  >
                    <ArrowLeftIcon className="w-3 h-3 text-green-400" />
          ...
          <div className="mt-8 text-center">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
              <p className="text-white/60 text-sm flex items-center justify-center gap-2">
                ...
                © 2024 FarmTeam. Growing together 🌱
